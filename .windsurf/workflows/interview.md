...
Apply the **interview-script** skill (read `skills/pm-product-discovery/interview-script.md`):
...
Apply the **summarize-interview** skill (read `skills/pm-product-discovery/summarize-interview.md`):
