...
Apply the **beachhead-segment** skill (read `skills/pm-go-to-market/beachhead-segment.md`):
...
Apply the **ideal-customer-profile** skill (read `skills/pm-go-to-market/ideal-customer-profile.md`):
...
Apply the **gtm-strategy** skill (read `skills/pm-go-to-market/gtm-strategy.md`):
