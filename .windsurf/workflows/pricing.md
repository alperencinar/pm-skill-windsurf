...
Apply the **pricing-strategy** skill (read `skills/pm-product-strategy/pricing-strategy.md`) and **monetization-strategy** skill (read `skills/pm-product-strategy/monetization-strategy.md`):
