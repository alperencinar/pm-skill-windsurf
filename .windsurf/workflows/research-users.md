...
Apply the **user-segmentation** skill (read `skills/pm-market-research/user-segmentation.md`) and **market-segments** skill (read `skills/pm-market-research/market-segments.md`):
...
Apply the **customer-journey-map** skill (read `skills/pm-market-research/customer-journey-map.md`):
