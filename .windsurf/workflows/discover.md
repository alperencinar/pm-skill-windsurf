...
Run a structured product discovery process that moves from divergent thinking to focused validation. This workflow chains multiple skills into a single end-to-end process.
...
Apply the **brainstorm-ideas-existing** skill (read `skills/pm-product-discovery/brainstorm-ideas-existing.md`) or **brainstorm-ideas-new** skill (read `skills/pm-product-discovery/brainstorm-ideas-new.md`):
...
For each selected idea, apply the **identify-assumptions-existing** skill (read `skills/pm-product-discovery/identify-assumptions-existing.md`) or **identify-assumptions-new** skill (read `skills/pm-product-discovery/identify-assumptions-new.md`):
...
Apply the **prioritize-assumptions** skill (read `skills/pm-product-discovery/prioritize-assumptions.md`):
...
For the top-priority assumptions, apply **brainstorm-experiments-existing** skill (read `skills/pm-product-discovery/brainstorm-experiments-existing.md`) or **brainstorm-experiments-new** skill (read `skills/pm-product-discovery/brainstorm-experiments-new.md`):
