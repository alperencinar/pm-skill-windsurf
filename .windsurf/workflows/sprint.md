...
Apply the **sprint-plan** skill (read `skills/pm-execution/sprint-plan.md`):
...
Apply the **retro** skill (read `skills/pm-execution/retro.md`):
...
Apply the **release-notes** skill (read `skills/pm-execution/release-notes.md`):
