...
Apply the **analyze-feature-requests** skill (read `skills/pm-product-discovery/analyze-feature-requests.md`):
...
Apply the **prioritize-features** skill (read `skills/pm-product-discovery/prioritize-features.md`):
