...
Apply the **user-stories** skill (read `skills/pm-execution/user-stories.md`):
...
Apply the **job-stories** skill (read `skills/pm-execution/job-stories.md`):
...
Apply the **wwas** skill (read `skills/pm-execution/wwas.md`):
