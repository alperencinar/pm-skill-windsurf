...
**If brainstorming ideas** — apply the **brainstorm-ideas-existing** skill (read `skills/pm-product-discovery/brainstorm-ideas-existing.md`) or **brainstorm-ideas-new** skill (read `skills/pm-product-discovery/brainstorm-ideas-new.md`):
...
**If brainstorming experiments** — apply the **brainstorm-experiments-existing** skill (read `skills/pm-product-discovery/brainstorm-experiments-existing.md`) or **brainstorm-experiments-new** skill (read `skills/pm-product-discovery/brainstorm-experiments-new.md`):
...
- "Should I **identify assumptions** behind the top ideas?"
- "Want to **design experiments** to validate the top ideas?"
- "Should I **prioritize** these against your current backlog?"
