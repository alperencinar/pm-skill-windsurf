...
**SWOT Analysis** (apply **swot-analysis** skill, read `skills/pm-product-strategy/swot-analysis.md`):
- Internal: Strengths and Weaknesses
- External: Opportunities and Threats
- Actionable recommendations for each quadrant

**PESTLE Analysis** (apply **pestle-analysis** skill, read `skills/pm-product-strategy/pestle-analysis.md`):
- Political, Economic, Social, Technological, Legal, Environmental factors
- Impact assessment and timeline for each factor

**Porter's Five Forces** (apply **porters-five-forces** skill, read `skills/pm-product-strategy/porters-five-forces.md`):
...
**Ansoff Matrix** (apply **ansoff-matrix** skill, read `skills/pm-product-strategy/ansoff-matrix.md`):
