...
Apply the **lean-canvas** skill (read `skills/pm-product-strategy/lean-canvas.md`) to produce a complete Lean Canvas:
...
Apply the **business-model** skill (read `skills/pm-product-strategy/business-model.md`) to produce all 9 building blocks:
...
Apply the **startup-canvas** skill (read `skills/pm-product-strategy/startup-canvas.md`) to produce a Startup Canvas with 9 strategy sections + business model:
...
Apply the **value-proposition** skill (read `skills/pm-product-strategy/value-proposition.md`) to produce a JTBD-framed value proposition:
